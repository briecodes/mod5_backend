users_list = [
    ...
    {name: 'Jesse', username: 'jesseh', password: 'pass'},
    {name: 'Daniel', username: 'danielb', password: 'pass'},
    {name: 'Ahamed', username: 'ahameda', password: 'pass'},
    {name: 'Roger', username: 'rogerp', password: 'pass'},
    {name: 'Arthur', username: 'arthurl', password: 'pass'},
    {name: 'Shawn', username: 'shawnt', password: 'pass'},
    {name: 'Shun', username: 'shuny', password: 'pass'},
    {name: 'Mike', username: 'mikem', password: 'pass'},
    {name: 'Gui', username: 'Guiz', password: 'pass'},
    {name: 'Lane', username: 'lanem', password: 'pass'},
    {name: 'Ryan', username: 'ryanh', password: 'pass'},
    {name: 'Ryan', username: 'ryano', password: 'pass'},
...
user_events_list = [
    ...
    {user_id: 12, event_id: 1},
    {user_id: 13, event_id: 1},
    {user_id: 14, event_id: 1},
    {user_id: 15, event_id: 1},
...
song_entry_list = [
    {user_id: 2, event_id: 1, song_title: 'Bodak Yellow', song_artist: 'Cardi-B', video_url: 'https://www.youtube.com/watch?v=1g8S-enLQ60', video_id: '1g8S-enLQ60'},
    {user_id: 3, event_id: 1, song_title: 'Waterfalls', song_artist: 'TLC', video_url: 'https://www.youtube.com/watch?v=N-E3Hyg7rh4', video_id: 'N-E3Hyg7rh4'},
    {user_id: 4, event_id: 1, song_title: 'End of the Road', song_artist: 'Boyz II Men', video_url: 'https://www.youtube.com/watch?v=rjPg9JqTxkY', video_id: 'rjPg9JqTxkY'},
    {user_id: 5, event_id: 1, song_title: 'Nice and Slow', song_artist: 'Usher', video_url: 'https://www.youtube.com/watch?v=8UFt4ru5S44', video_id: '8UFt4ru5S44'},
    {user_id: 6, event_id: 1, song_title: 'Like a Prayer', song_artist: 'Madonna', video_url: 'https://www.youtube.com/watch?v=naY0RYV7AEc', video_id: 'naY0RYV7AEc'},
    {user_id: 7, event_id: 1, song_title: 'Sweet Lady', song_artist: 'Tyrese', video_url: 'https://www.youtube.com/watch?v=34tYnpCMQx0', video_id: '34tYnpCMQx0'},
    {user_id: 8, event_id: 1, song_title: 'If I were a Boy', song_artist: 'Beyonce', video_url: 'https://www.youtube.com/watch?v=56kZ5BYfO6E', video_id: '56kZ5BYfO6E'},
    {user_id: 9, event_id: 1, song_title: 'Love on the Brain', song_artist: 'Rihanna', video_url: 'https://www.youtube.com/watch?v=4Jfy1ulVgvc', video_id: '4Jfy1ulVgvc'},
    {user_id: 10, event_id: 1, song_title: 'Cry me a River', song_artist: 'Justin Timberlake', video_url: 'https://www.youtube.com/watch?v=98rhQnv3lDE', video_id: '98rhQnv3lDE'},
    {user_id: 11, event_id: 1, song_title: 'Baby One More Time', song_artist: 'Brittany Spears Bitch', video_url: 'https://www.youtube.com/watch?v=PYpU2TxIzAM', video_id: 'PYpU2TxIzAM'},
    {user_id: 12, event_id: 1, song_title: 'Im Real', song_artist: 'J-Lo', video_url: 'https://www.youtube.com/watch?v=vuYF4FQDsh4', video_id: 'vuYF4FQDsh4'},
    {user_id: 13, event_id: 1, song_title: 'Get Low', song_artist: 'Lil Jon', video_url: 'https://www.youtube.com/watch?v=_l9EHJ5ucNk', video_id: '_l9EHJ5ucNk'},
    {user_id: 14, event_id: 1, song_title: 'Miracle Aligner', song_artist: 'TLSP', video_url: 'https://www.youtube.com/watch?v=f62SD4G6disf', video_id: 'f62SD4G6disf'},
    {user_id: 15, event_id: 1, song_title: 'Maps', song_artist: 'Yeah Yeah Yeahs', video_url: 'https://www.youtube.com/watch?v=3N-9cRFEo38&t=3s', video_id: '3N-9cRFEo38&t=3s'},
    {user_id: 16, event_id: 1, song_title: 'Us', song_artist: 'Regina Spektor', video_url: 'https://www.youtube.com/watch?v=NLlY7hLVVxQ', video_id: 'NLlY7hLVVxQ'},
